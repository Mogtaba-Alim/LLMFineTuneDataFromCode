...
# Define paths
input_dir = './Papers'
output_file = 'finetuning_dataset.csv'
            ...
            for chunk in paper_chunks:
                for question in questions:
                    ...
                    if api_choice == (1, 0, 0):
                        ...
                        raise ValueError("Invalid API choice. The one-hot vector must be one of (1, 0, 0), (0, 1, 0), or (0, 0, 1).")
                    data.append({
                        'filename': filename,
                        'question': question,
                        'chunk': chunk,
...
api_choice = (0, 1, 0)  # Choose the API: (GPT-3.5, GPT-4o, Cohere)
